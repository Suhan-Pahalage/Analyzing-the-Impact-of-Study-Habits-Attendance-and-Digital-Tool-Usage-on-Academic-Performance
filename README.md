...
## Project Overview
This repository contains the complete statistical analysis, data preparation workflows, Minitab project workspace, and final report for **STA 330 2.0 Data Analysis and Preparation of Reports**[cite: 1].

* **Project Title:** Analyzing the Impact of Study Habits, Attendance, and Digital Tool Usage on Academic Performance[cite: 1]
* **Group:** Team 12[cite: 1]
* **Institution:** Department of Statistics, University of Sri Jayewardenepura[cite: 1]
...
* **Group Comparisons:** Statistical tests (e.g., Two-sample t-tests, ANOVA, or Mann-Whitney U / Kruskal-Wallis) to assess differences in academic performance across demographic and study-habit groups.
